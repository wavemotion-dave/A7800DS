...
Database_Entry game_list[] = {
  ...
  {"1330d23ebad9b5ded92ebeacdf305abd",  "Pac-Man XM",                       CT_SUPCAR,  POKEY_AT_450, JOY, JOY,  DIFF_A,  DIFF_A, NTSC,  STEAL_CYCLE,    USES_WSYNC, HSC_YES, 0,  25, 256,  220}, // title=Pac-Man Collection 40th Anniversary Edition (homebrew) - XM (fixed)
