...
Database_Entry game_list[] = {
  ...
  {"e7d89669a7f92ec2cc99d9663a28671c",  CT_NORMAL,    POKEY_NONE, JOY, JOY,  NTSC,  NO_STEALING,    USES_WSYNC, HSC_YES, 30, 15, 320,  205}, // title=Frenzy (with Berzerk) (homebrew)
  ...
  {"044657294450c869c45e7ef61f4870de",  CT_SUPCAR,  POKEY_AT_450, JOY, JOY,  NTSC,  STEAL_CYCLE,    USES_WSYNC, HSC_YES, 0,  27, 256,  220}, // title=Pac-Man Collection 40th Anniversary Edition (homebrew) - Pokey Version
  {"e66f3812d74724cdb3ae489e5c7d1c0e",  CT_SUPCAR,    POKEY_NONE, JOY, JOY,  NTSC,  STEAL_CYCLE,    USES_WSYNC, HSC_YES, 0,  27, 256,  220}, // title=Pac-Man Collection 40th Anniversary Edition (homebrew) - Forced TIA
