...
----------
 ...
 If you want to use a real Atari 7800 BIOS, find yourself the 4K version and place it into
 the same directory as mentioned in the paragraph above. It doesn't do much except show a
 cool pulsing Atari logo when booting a game... but it adds to the authenticity of playing.
...
other artifacts on screen. However, in the past few years I've worked out many of those
...
- PAL is not supported - use NTSC ROMs instead.
...
V4.7 : 11-May-2025 by wavemotion-dave
...
V4.6 : 06-May-2025 by wavemotion-dave
